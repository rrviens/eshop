<?php
$sql = "SELECT * FROM produktai WHERE featured = 7 and id = 20";
$featured = $db->query($sql);
 ?>
<div class="modal fade details-1" id="details-20" tableindex="-1" role="dialog" aria-labelledby="details-20" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <?php
        //get rows query
        $query = $db->query("SELECT id FROM produktai where id=20");
        if($query->num_rows > 0){
