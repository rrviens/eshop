<?php
$sql = "SELECT * FROM produktai WHERE featured = 7 and id = 19";
$featured = $db->query($sql);
 ?>
<div class="modal fade details-1" id="details-19" tableindex="-1" role="dialog" aria-labelledby="details-19" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <?php
        //get rows query
        $query = $db->query("SELECT id FROM produktai where id=19");
        if($query->num_rows > 0){
