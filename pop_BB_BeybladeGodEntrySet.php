<?php
$sql = "SELECT * FROM produktai WHERE featured = 1 and id = 3";
$featured = $db->query($sql);
 ?>
<div class="modal fade details-1" id="details-3" tableindex="-1" role="dialog" aria-labelledby="details-3" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <?php
        //get rows query
        $query = $db->query("SELECT id FROM produktai where id=3");
        if($query->num_rows > 0){
